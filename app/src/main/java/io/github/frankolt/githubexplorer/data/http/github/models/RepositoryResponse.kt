...
data class RepositoryResponse(
    ...
    @Json(name = "archived") val isArchived: Boolean? = null,
    @Json(name = "disabled") val isDisabled: Boolean? = null,
    @Json(name = "visibility") val visibility: String? = null,
    @Json(name = "permissions") val permissions: RepositoryPermissionsResponse? = null,
    @Json(name = "allow_rebase_merge") val allowRebaseMerge: Boolean? = null,
    @Json(name = "template_repository") val templateRepository: RepositoryResponse? = null,
    @Json(name = "temp_clone_token") val tmpCloneToken: String? = null,
    @Json(name = "allow_squash_merge") val isSquashMergeAllowed: Boolean? = null,
    @Json(name = "delete_branch_on_merge") val shouldDeleteBranchOnMerge: Boolean? = null,
    @Json(name = "subscribers_count") val subscribersCount: Long? = null,
    @Json(name = "network_count") val networkCount: Long? = null,
    @Json(name = "license") val license: LicenseResponse? = null,
    @Json(name = "organization") val organization: UserResponse? = null
)
